...
<body>
  ...
  <section class="contact_section layout_padding">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6">
          <form action="action.php" method="post"> <!-- Correction ici -->
            <div><input type="text" placeholder="Nom" name="nom"  /></div>
            <div><input type="text" placeholder="Prénom" name="prenom"  /></div>
            <div><input type="email" placeholder="Pseudo" name="pseudo"  /></div>
            <div><input type="password" placeholder="Mot de passe" name="mdp1"  /></div>
            <div><input type="password" placeholder="Confirmer le Mot de passe" name="mdp2" /></div>
            <div class="d-flex"><button type="submit">ENVOYER</button></div>
          </form>
        </div>
        <div class="col-md-6">
